...
/**
 * UploadSection - Handles PDF file uploads with drag & drop
 * @param {Array} uploadedPDFs - Array of uploaded PDFs (from parent)
 * @param {Function} setUploadedPDFs - Function to update uploaded PDFs (from parent)
 */
function UploadSection({ uploadedPDFs = [], setUploadedPDFs }) {
  ...
  return (
    <AnimatedCard delay={0}>
      <h2 className="text-2xl font-bold text-white mb-6 tracking-tight">Upload PDFs</h2>
      ...
      <motion.div
        ...
        className="border-2 border-dashed border-slate-700/60 rounded-2xl p-8 text-center backdrop-blur-sm"
      >
        <motion.div
